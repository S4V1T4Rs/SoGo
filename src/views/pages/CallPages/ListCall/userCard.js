        ...
        {editing ? (
          <>
            <TextDinamic
              ...
              values={[
                updatedUserData['Datos Personales'].Nombre,
                updatedUserData['Datos Personales'].Apellido,
                updatedUserData['Datos Personales'].FechaNacimiento,
                updatedUserData['Datos Personales'].Edad,
                updatedUserData['Datos Personales'].TipoDocumento
              ]}
          ...
          <>
            <Typography variant="h6" component="div" gutterBottom>
              {user['Datos Personales'].Nombre} {user['Datos Personales'].Apellido}
            </Typography>
            <Typography variant="body2" component="p" gutterBottom>
              Tipo de Documento: {user['Datos Personales'].TipoDocumento}
            </Typography>
            <Typography variant="body2" component="p" gutterBottom>
              Número de Documento: {user['Datos Personales'].NumeroDocumento}
            </Typography>
            {/* <Typography variant="body2" component="p" gutterBottom>
